...
export default class PButtom4 extends Component<PButtom_props> {
    ...
    render() {
        ...
        var bgColor =STheme.color.white ;
        var colorText = STheme.color.black;
        if (this.props.withe) {
            bgColor = "#fff"
        ...
        return (<SView height={size.height} style={{
            ...
            borderTopWidth:1,
            borderTopColor:STheme.color.gray,
            width: "100%",
            maxWidth: size.width,
