...
public class Entrenamiento
{
    ...
    public void editar(final JSONObject obj, final SSSessionAbstract session) {
        try {
            ...
            SPGConect.editObject("entrenamiento", entrenamiento);
            SPGConect.historico(obj.getString("key_usuario"), entrenamiento.getString("key"), "entrenamiento_editar", entrenamiento);
    ...
    public void registro(final JSONObject obj, final SSSessionAbstract session) {
        try {
            ...
            SPGConect.insertArray("entrenamiento", new JSONArray().put((Object)entrenamiento));
            obj.put("data", (Object)entrenamiento);
            obj.put("estado", (Object)"exito");
            SSServerAbstract.sendAllServer(obj.toString());
        }
