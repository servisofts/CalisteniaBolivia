...
public class TipoComision {
    ...
    public static final String COMPONENT = "tipo_comision";
    public static final String nombre_tabla = "tipo_comision";

    public TipoComision(JSONObject data, SSSessionAbstract session) {
