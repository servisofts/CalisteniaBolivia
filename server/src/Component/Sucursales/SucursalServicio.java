...
public class SucursalServicio {
    ...
    public static final String COMPONENT = "sucursal_servicio";
    public static final String nombre_tabla = "sucursal_servicio";

    public SucursalServicio(JSONObject data, SSSessionAbstract session) {
    ...
    public void getAll(JSONObject obj, SSSessionAbstract session) {
        try {
            ...
            if(obj.has("key_servicio")){
                consulta = "select get_all('"+nombre_tabla+"', 'key_servicio', '"+obj.getString("key_servicio")+"') as json";
            }
