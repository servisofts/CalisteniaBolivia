    ...
    public static void sincronizarLog(JSONObject obj) {
        try {
            if (obj.getString("estado").equals("exito")) {
                ...
                console.log(console.ANSI_GREEN, "Sincronizando Logs key_sucursal=" + obj.getString("key_sucursal")
                ...
                if (asistencias_pendientes.getString("estado").equals("exito")) {
                    ...
                    console.log(console.ANSI_GREEN, "Asistencias pendientes" + cantidad);
                ...
                console.log(console.ANSI_GREEN, "Sincronizacion exitosa");
                obj.put("noSend", true);
