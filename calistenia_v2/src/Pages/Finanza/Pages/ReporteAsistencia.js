    ...
    getLista() {
        ...
        return <STable2
            header={[
                ...
                { key: "entrenamiento/descripcion", label: "tipo", width: 150, },
                ...
                { key: "entrenamiento/fecha_fin", label: "Fecha Fin", width: 150, render: (item) => { return new SDate(item).toString("yyyy-MM-dd hh:mm") } },
