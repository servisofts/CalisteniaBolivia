  ...
  getLista() {
    ...
    return <STable2
      header={[
        ...
        { key: "efectivo", label: "Efectivo", width: 120, center: true, sumar: true, render: (item) => { return item ? SMath.formatMoney(item) : "0" }, icon: (<SIcon name={"Money"} width={12} height={12} />), },
