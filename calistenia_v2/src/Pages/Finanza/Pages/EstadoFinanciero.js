...
import { SDate, SIcon, SLoad, SNavigation, SPage, STable2 } from 'servisofts-component';
  ...
  getLista() {
    ...
    return <STable2
      header={[
        ...
        { key: "total_pagado", label: "Total pagado", width: 140, center: true, sumar: true, render: (item) => { return item ? item : "0" }, icon: (<SIcon name={"Ingreso"} width={12} height={12} />), },
        { key: "egresos_banco", label: "Egresos banco", width: 100, sumar: true, center: true, render: (item) => { return item ? item : "0" }, icon: (<SIcon name={"Egreso"} width={12} height={12} />), },
        { key: "egresos_caja", label: "Egresos caja", width: 120, center: true, sumar: true, render: (item) => { return item ? item : "0" }, icon: (<SIcon name={"Egreso"} width={12} height={12} />), },
        { key: "-", label: "Saldo", width: 140, sumar: true, center: true, render: (item) => { return item.efectivo + item.egresos_caja }, icon: (<SIcon name={"Ingreso"} width={12} height={12} />) },
