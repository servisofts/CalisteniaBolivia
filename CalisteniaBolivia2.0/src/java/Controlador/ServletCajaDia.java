 ...
 * @author pc
 */
@WebServlet(name = "ServletCajaDia", urlPatterns = {"/ServletCajaDia"})
public class ServletCajaDia extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServletCajaDia</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServletCajaDia at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList lista = PersonalBD.mostrarDetalleEgresoCaja(fe,j);
            ...
            for (int i = 0; i < lista.size(); i++) {
                ...
                String html="<td> <a href="+"modificarEgreso.jsp?id="+id+" class="+"btn btn-warning"+">"+
