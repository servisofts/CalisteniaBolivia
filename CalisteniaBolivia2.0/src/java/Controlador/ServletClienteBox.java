 ...
 * @author pc
 */
@WebServlet(name = "ServletClienteBox", urlPatterns = {"/ServletClienteBox"})
public class ServletClienteBox extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServletClienteBox</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServletClienteBox at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            for (int i = 0; i < lista.size(); i++) {
                ...
                String html="<td> <a href="+"kickboxing11.jsp?id="+id+" class="+"btn btn-warning"+">"+
