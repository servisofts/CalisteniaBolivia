...
public class UploadServlet2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet UploadServlet2</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet UploadServlet2 at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            int idCliente=Integer.parseInt(l2.get(0));
            String nombre = l2.get(1);
            System.out.println(nombre);
            String apellido=l2.get(2);
            String edad=l2.get(3);
            int ci=Integer.parseInt(l2.get(4));
            String telefono=l2.get(5);
            int idZona=Integer.parseInt(l2.get(6));
            String correo=l2.get(7);
            int idContacto=Integer.parseInt(l2.get(8));
            if(s.equals(""))
            {
                s=l2.get(9);
            }
            String imagen=s;
             Cliente cl=new Cliente(idContacto,idCliente,nombre,apellido,edad,ci,telefono,correo,imagen,idZona);
             boolean rpta=ClienteBD.modificarCliente3(cl);
             if(rpta)
             {
