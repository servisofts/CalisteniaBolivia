 ...
 * @author pc
 */
@WebServlet(name = "ServletCaja", urlPatterns = {"/ServletCaja"})
public class ServletCaja extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServletCaja</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServletCaja at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            for (int i = 0; i < lista.size(); i++) {
                ...
                String imagen ="images/caliii.jpg";
                int id = cl.getIdCliente();
                String historial = "<td> <a href="+"historial.jsp?id="+id+" class="+"btn btn-warning"+">"+
                           "<strong>Historial</strong>"+
                           "<span class=fa fa-refresh"+"></span>";
                String html="<td> <a href="+"modificarCliente.jsp?id="+id+" class="+"btn btn-warning"+">"+
