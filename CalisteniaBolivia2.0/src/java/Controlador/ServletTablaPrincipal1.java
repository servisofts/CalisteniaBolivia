 ...
 * @author pc
 */
@WebServlet(name = "ServletTablaPrincipal1", urlPatterns = {"/ServletTablaPrincipal1"})
public class ServletTablaPrincipal1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServletTablaPrincipal1</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServletTablaPrincipal1 at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<Cliente> lista = ClienteBD.mostrarClienteActivo2(nombre1);
