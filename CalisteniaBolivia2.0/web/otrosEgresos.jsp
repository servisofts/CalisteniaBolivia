            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="ServletControlador" method="post" onsubmit="return confirmar(event);">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-4 col-sm-3 col-xs-12">Seleccione el Personal</label>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <select class="form-control" id="txtPersonal" name="txtAEnviarp" >
                              <%
                                            ArrayList<Personal> listaPer= PersonalBD.mostrarPersonalP();


                                            for(Personal c:listaPer)
                                            {
                                                %>
                               <option value="<%=c.getIdPersonal()%>"><%=c.getNombrePersonal()%> <%=c.getApellidoPersonal()%></option>
                               <%
                      ...
                      <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Pago Cheque</label>
                                ...
                                <input type="text" id="txtChequep" name="cbtipopagop"  class="inputText1" value="CHEQUE" readonly="" required="required"/>
                                </div>
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <input type="text" class="form-control" data-inputmask="'mask' : '999999999999'" id="txtNumChequep" name="txtNumEp"  class="inputText" placeholder="Numero del Cheque"  required="required" >
                      ...
                      <div class="form-group">
                            ...
                            <div class="col-md-1 col-sm-1 col-xs-1"> 
                                ...
                                <div class="col-md-2 col-sm-2 col-xs-12"> 
                                <select class="form-control" id="txbEntidadCp" name="cbtipopagop" disabled="disabled" >
                                            <%
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-12"> 
                                <input type="text" class="form-control" data-inputmask="'mask' : '9999-9999-9999-9999'" id="txtNumTarjetap" name="txtNumEp" disabled class="inputText" placeholder="Numero de la Tarjeta"  required="required">
                        ...
                        <div class="col-md-6  col-sm-6 col-xs-12">
                            <input type="text" name="txtMontop"  required="">
                      ...
                      <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                            ...
                            <input type="hidden" name="accion" value="AnadirEgresoChequeTrans"/>
                        </div>
                      </div>
...
document.getElementById('txtChequep').disabled=false;
document.getElementById('txtNumChequep').disabled=false;
document.getElementById('txbEntidadCp').disabled=true;
document.getElementById('txtNumTarjetap').disabled=true;
}
function habilitartarjeta(){
document.getElementById('txtChequep').disabled=true;
document.getElementById('txtNumChequep').disabled=true;
document.getElementById('txbEntidadCp').disabled=false;
document.getElementById('txtNumTarjetap').disabled=false;
}
</script>
