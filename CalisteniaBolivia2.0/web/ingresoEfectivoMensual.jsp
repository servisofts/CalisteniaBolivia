        ...
        <div class="right_col" role="main">
          ...
          <!-- /top tiles -->
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                    <h2>Reportes de Ingresos Efectivos <code>CALISTENIA y BOXEO</code></h2>
                    ...
                    <form id="formulario" data-parsley-validate class="form-horizontal form-label-left" action=
                        ...
                        <div class="col-md-9 col-sm-6 col-xs-12">
                          <div class="control-group">
                            <div class="controls">
                                <label class="control-label col-md-7 col-sm-39 col-xs-12" for="first-name">Mostrar Total de <code>INGRESO EFECTIVO CALISTENIA</code>por Fecha y Personal</label>
                            </div>
                          </div>
                        ...
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Personal
                             ...
                             <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <%
                                            ArrayList<Personal> listaPer6= PersonalBD.mostrarPersonalContratoACtivo();


                                            for(Personal c:listaPer6)
                                            {
                                                %>
          ...
          <br />
                ...
                <!--  FIN INGRESO EFECTIVO DE PERSONAL-->  
                
                <!--  TOTAL INGRESO EFECTIVO Box DE PERSONAL-->
                 <div class="agile-title form-group">                             
                    <form id="formulario" data-parsley-validate class="form-horizontal form-label-left" action=
                           "estadoIngresoEfectivoBoxMes.jsp" method="post" >
                        <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">
                        </label>
                        <div class="col-md-9 col-sm-6 col-xs-12">
                          <div class="control-group">
                            <div class="controls">
                            <label class="control-label col-md-7 col-sm-39 col-xs-12" for="first-name">Mostrar Total de <code>INGRESO EFECTIVO BOXEO</code>por Fecha y Personal</label>
                            </div>
                          </div>
                        ...
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Personal
                             ...
                             <div class="col-md-6 col-sm-6 col-xs-12">
                                              <input type="text" list="listadedatos" id="cliente" name="txbPerspnalL" required class="form-control col-md-7 col-xs-12" placeholder="Digite el nombre del Personal" required="">
                                                <datalist id="listadedatos">
                                            <%
                                            ArrayList<Personal> listaPer6b= PersonalBD.mostrarPersonalContratoACtivo();


                                            for(Personal c:listaPer6b)
                                            {
                                                %>
          ...
          <br />
                ...
                <!--  FIN INGRESO EFECTIVO Box DE PERSONAL--> 
