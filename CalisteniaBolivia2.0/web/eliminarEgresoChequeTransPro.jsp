        ...
        <div class="right_col" role="main">
          ...
          <!-- /top tiles -->
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                    <h2>Eliminar Otros Egresos <code>CHEQUE o TRANSACCION BANCARIA</code> Proveedor</h2>
            ...
            <div class="row">
                    ...
                    <form id="formulario" data-parsley-validate class="form-horizontal form-label-left" action=
                           "eliminarEgresoChequeTransProAct.jsp" method="post" >
          ...
          <br />
                     ...
                     <div class="agile-title form-group">                             
                    <form id="formulario" data-parsley-validate class="form-horizontal form-label-left" action=
                           "eliminarEgresoChequeTransProInac.jsp" method="post" >
                        <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
