        ...
        <div class="right_col" role="main">
          ...
          <!-- /top tiles -->
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Eliminar Egreso Personal</h2>
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                      Puede Buscar El Egreso por Nombre de Cliente: <code>NOMBRE o APELLIDO</code>
                    </p>
                    ...
                    %> 
                      ...
                      <tbody>
                           ...
                           <%
                            ...
                            ArrayList<EgresoPersonal> lista= EgresoPersonalBD.mostrarEliminarEgreso();

                            for(int i=0;i<lista.size();i++)
                            {
                                EgresoPersonal cl=lista.get(i);
                                        %>
                            <tr>
                                <td><%=cl.getNombre()%></td>
                                <td><%=cl.getApellido()%></td>
                                <td><%=cl.getMonto()%></td>
                                <td><%=cl.getObservacion()%></td>
                                <%
                    if((sesionOK.getAttribute("cargo").equals("Gerencia"))||(sesionOK.getAttribute("cargo").equals("Administrador"))){
                    %> 
                                <td> <a href="#<%=cl.getEgresoCaja()%>" class="btn btn-danger" data-toggle="modal">
                           <strong> Eliminarr </strong>
                           <span class="glyphicon glyphicon-remove"></span>
                            </a>
                           <!-- Eliminar Ingreso -->
                    <div class="modal fade" id="<%=cl.getEgresoCaja()%>">
                                    ...
                                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="ServletControlador" method="post"  onsubmit="return confirmar()">
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <div class="col-md-1 col-sm-6 col-xs-12">
                                                <input type="text" id="first-name" name="txbEgresoCaja" required="required" class="form-control col-md-7 col-xs-12" value="<%=cl.getEgresoCaja()%>" style=" visibility: hidden">
                                          </div>
                                          <div class="col-md-1 col-sm-6 col-xs-12">
                                                <input type="text" id="first-name" name="txbEgresoPersonal" required="required" class="form-control col-md-7 col-xs-12" value="<%=cl.getIdEgresoPersonal()%>" style=" visibility: hidden">
                                          </div>
                                          <div class="col-md-1 col-sm-6 col-xs-12">
                                                <input type="text" id="first-name" name="txbCEgresoCaja" required="required" class="form-control col-md-7 col-xs-12" value="<%=cl.getIdConceptoEgresoPersonal1()%>"style=" visibility: hidden">
                                          </div>
                                          <div class="col-md-1 col-sm-6 col-xs-12">
                                                <input type="text" id="first-name" name="txbCaja" required="required" class="form-control col-md-7 col-xs-12" value="<%=cl.getIdCaja()%>" style=" visibility: hidden">
                                          </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-md-5 col-sm-6 col-xs-12">
                                              <input type="text" id="last-name" name="txbMonto" required="required" class="form-control col-md-7 col-xs-12" value="<%=cl.getMonto()%>" readonly="">
                                          </div>
                                        </div>
                                        <div class="form-group">
                                          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Glosa <span class="required">*</span>
                                          </label>
                                          <div class="col-md-5 col-sm-6 col-xs-12">
                                              <input type="text" id="last-name" name="txbPrecio" required="required" class="form-control col-md-7 col-xs-12" value="<%=cl.getObservacion()%>" readonly="">
                                          </div>
                                        </div>  
                                        <div class="ln_solid"></div>
                                        <div class="ln_solid"></div>
