    ...
    <div class="container body">
        ...
        <div class="right_col" role="main">
          ...
          <!-- /top tiles -->
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                    <h2>Estado Calistenia Ingreso Tarjeta</h2>
        ...
        <div class="w3ls-row" id="div1">
            ...
            <div class="table-responsive">
                <div class="agile-title"  >
                    <H2>Ingreso Tarjeta Calistenia entre la Fecha <label class="red"><% out.println(fechaini);%></label> y Fecha <label class="red"><% out.println(fechafin);%></label> </H2> 
                </div>
            <label>Ingreso Total: </label><br>
           <%
                    if((sesionOK.getAttribute("cargo").equals("Gerencia"))||(sesionOK.getAttribute("cargo").equals("Administrador"))){
                    Ingreso icp= IngresoBD.mostrarTotalIngresoCaliTarjetaFechaXFecha(idContrato2, fechaini, fechafin);
                    %>
			...
			<th>Fecha</th>
                        ...
                        <tbody>
                            ...
                            ArrayList<Ingreso> lista2= 
                                    IngresoBD.mostrarIngresoCaliTarjetaFechaXFecha(idContrato2, fechaini, fechafin);
