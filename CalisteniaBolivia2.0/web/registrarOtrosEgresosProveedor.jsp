    ...
    <div class="container body">
        ...
        <div class="right_col" role="main">
          ...
          <!-- /top tiles -->
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Otros Egresos (Proveedor) <code>CHEQUE o TRANSACCION BANCARIA</code></h2>
                  ...
                  <div class="x_content">
                    <div class="row">
                      <div class="col-sm-12 table-responsive">
                        ...
                        <input type="hidden" name="accion" value="RegistrarEgresoChequeTransPro"/>
        ...
        <%
                ArrayList<EgresoChequeTransPro> lista= 
                        (ArrayList<EgresoChequeTransPro>)session.getAttribute("carrito3");

            if(lista!=null){
                int salto=0;
                for(EgresoChequeTransPro co:lista)
                {
                    %>
                    <th><%=co.getProveedor().getRazonSocial()%></th>
                    <th><%=co.getProveedor().getNombre()%> <%=co.getProveedor().getApellido()%></th>
                    <th> <%=co.getMonto()%></th>
                    ...
                    <th> 
                        <span id="idProveedor" style="display:none;"><%=co.getProveedor().getIdProveedor()%></span>
                        <a id="deleteitem3"><i class="fa fa-times btn btn-danger"></i></a>
                    </th>
