...
<body class="nav-md">
                            ...
                            <div class="row">
                                <div class="col-sm-12 table-responsive">
                                    <div class="card-box " id="cart-container">
                                        ...
                                        <input type="hidden" name="accion" value="RegistrarVentaBox"/>
                                            <table class="table table-striped" id="datos">
                                                <thead>
                                                    <tr>
                                                        <th>Cliente/Razon social:</th>
                                                        <th><input type="text" name="txtCliente"></th>
                                                        <th>NIT:</th>
                                                        <th><input type="text" name="txtNIT"></th>
                                                    </tr>
                                                    <tr>
                                                        <th>Usuario:</th>
                                                ...
                                                <%
                                                    float total=0;
                                                    int cantidad=0;
                                                        ArrayList<contratoKick> lista= 
                                                        (ArrayList<contratoKick>)session.getAttribute("carrito1");
                                                    if(lista!=null){
                                                        int salto=0;
                                                        for(contratoKick co:lista)
                                                        {
                                                %>
                                                    <tr>
                                                        <th><%=co.getCliente().getNombre()%> <%=co.getCliente().getApellido()%></th>
                                                        <th><%=co.getFechaInicio()%></th>
                                                        <th> <%=co.getFechaFin()%></th>
                                                        <th> <%=co.getPaquete().getNombrePaquete()%></th>
                                                        <th> <%=co.getPaquete().getPrecioPaquete()%></th>
                                                        <th> <%=co.getTipoPago()%></th>
                                                        <% if(co.getTipoPago().equals("Tarjeta")) {%>
                                                        <th> <%=co.getEntidadFinanciera().getNombreEntidad()%></th>
                                                        <th> <%=co.getNumeroTarjeta()%></th>
                                                <%  }
                                                else{
                                                %>
                                                        <th></th>
                                                ...
                                                %>
                                                        ...
                                                        <th> 
                                                            ...
                                                            <a id="deleteitem1"><i class="fa fa-times btn btn-danger"></i></a>
                                                        </th>
                                                    </tr>
                                            <%
                                        ...
                                        <tr >
                                            <th colspan="4"></th>
                                            <td><button  type="submit" id="btnVenta" name="btnVenta" class=" btn btn-primary btn-group-lg">
                                                            <strong> Registrar Venta CON Factura </strong>
                                                            <span class="glyphicon glyphicon-floppy-saved"></span>
                                                            </button>
                                                            
                                                            <button type="submit" id="btnVentaR" name="btnVentaR" class="btn btn-primary btn-group-lg">
                                                            <strong> Registrar Venta CON Recibo</strong>
                                                            <span class="glyphicon glyphicon-floppy-saved"></span>
                                                            </button>
                                                            
                                                            <button type="submit" id="btnVentaS" name="btnVentaS" class="btn btn-primary btn-group-lg">
                                                            <strong> Registrar Venta SIN Comprobante</strong>
                                                            <span class="glyphicon glyphicon-floppy-saved"></span>
                                                            </button>
                                            </td>
                                            <th colspan="4"></th>
    ...
    <script src="js/carritoBox.js"></script>
    <!-- Datatables -->
    <script>
