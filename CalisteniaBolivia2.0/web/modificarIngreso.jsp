...
<%
    ...
    ArrayList list = PersonalBD.mostrarDetalleIngresoCaja2(Integer.parseInt(request.getParameter("id")));
    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Modificar datos del Ingreso</h2>
                    ...
                    <form class="form-horizontal form-label-left" action="ServletControlador" method="post" >                        
                      <div class="form-group">
                        ...
                        <div class="control-label col-md-2 col-sm-2 col-xs-12">
                            <input type="text" class="form-control" value="<%=list.get(0)%>" readonly="" name="idIngreso">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                            ...
                            <input type="hidden" name="accion" value="ModificarIngresoCaja"/>
                        </div>
                      </div>
