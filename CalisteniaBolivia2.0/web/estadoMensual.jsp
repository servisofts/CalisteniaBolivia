        ...
        <div class="right_col" role="main">
          ...
          <!-- /top tiles -->
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Estado De Caja <code>MENSUAL O CAJA CERRADA DEL DIA DEL PERSONAL</code>></h2>
                    ...
                    <form id="formulario" data-parsley-validate class="form-horizontal form-label-left" action=
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="control-group">
                            <div class="controls">
                            <label class="control-label col-md-9 col-sm-39 col-xs-12" for="first-name">Mostrar Cierre Completo de Caja por Fecha y Sucursal</label>
                            </div>
                          </div>
                        ...
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Sucursal
                          ...
                          <select class="form-control" name="txbPerspnalL">
                               <%
                                            ArrayList<Sucursal> listaPer= SucursalBD.mostrarSucursalACtivas();


                                            for(Sucursal c:listaPer)
                                            {
                                                %>

                                                        <option value="<%=c.getIdSucursal()%>" ><%=c.getNombreSucursal()%></option>
                                                         <%
          ...
          <br />
                ...
                <!--  FIN CIERRE DE CAJA DEL PERSONAL-->
                
                <!--  TOTAL DE CAJA MENSUAL DE PERSONAL-->
                    <div class="agile-title form-group">                             
                    <form id="formulario" data-parsley-validate class="form-horizontal form-label-left" action=
                           "estadoMontoMensual.jsp" method="post" >
                        <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="control-group">
                            <div class="controls">
                            <label class="control-label col-md-9 col-sm-39 col-xs-12" for="first-name">Mostrar Total de Caja por Fecha y Sucursal</label>
                            </div>
                          </div>
          ...
          <br />
                ...
                <!--  FIN TOTAL DE CAJA MENSUAL DE PERSONAL-->    
