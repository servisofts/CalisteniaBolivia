...
<!DOCTYPE html>
                    <%
                    if(sesionOK1.getAttribute("cargo")!=null){
                        ArrayList<Historial> cl = ClienteBD.historial(Integer.parseInt(request.getParameter("id")));
                    %>
<html lang="en">
  <head>
                  ...
                  <div class="x_title">
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tr>
                          ...
                          <td id='tipoPaquete'><%=cl.get(i).getTipoPaquete()%></td>
                          <td id='precio'><%=cl.get(i).getPrecio()%></td>
                      </tr>
                          <% } %>
                      </body>
                    </table>
