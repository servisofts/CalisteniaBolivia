    ...
    <div class="container body">
        ...
        <div class="w3ls-row" id="div1">
            ...
            <div class="table-responsive">
                <div class="agile-title"  >
                    <H2>Cierre de Caja entre la Fecha <label class="red"><% out.println(fechaini);%></label> y Fecha <label class="red"><% out.println(fechafin);%></label> </H2> 
                </div>
            <label>Total:  </label><br>
            <%
                    if((sesionOK.getAttribute("cargo").equals("Gerencia"))||(sesionOK.getAttribute("cargo").equals("Administrador"))){
                    CierreCaja icp= CierreCajaBD.MostrarCierreCajaTotalXFechaXFecha(idContrato2, fechaini, fechafin);
                    %>
			...
			<th>Ingreso Efectivo</th>
                        ...
                        <tbody>
                            ...
                            ArrayList<CierreCaja> lista0= 
                                    CierreCajaBD.MostrarCierreCajaXFechaXFecha(idContrato2,fechaini,fechafin);

                            for(int i=0;i<lista0.size();i++)
                            {
                                CierreCaja cc=lista0.get(i);
                                        %>
                            <tr>
                                <td><%=cc.getNombre()%> <%=cc.getApellido()%></td>
                                <td><%=cc.getFechaCierre()%> : <%=cc.getHora()%></td>
                                <td><%=cc.getEfectivo()%></td>
                            </tr>
                            <%
