    ...
    <div class="container body">
        ...
        <div class="w3ls-row" id="div1">
            ...
            <div class="table-responsive">
                <div class="agile-title"  >
                    <H2>Egreso entre la Fecha <label class="red"><% out.println(fechaini);%></label> y Fecha <label class="red"><% out.println(fechafin);%></label> </H2> 
                </div>
            <label>Total:  </label><br>
            <%
                    if((sesionOK.getAttribute("cargo").equals("Gerencia"))||(sesionOK.getAttribute("cargo").equals("Administrador"))){
                    EgresoPersonal icp= EgresoPersonalBD.mostrarTotalEgresoPersonalFechaXFecha(idContrato2, fechaini, fechafin);
                    %>
                    <label class="blue"><%=icp.getMonto()%> Bs</label>
            <%
                        }
                        %>
			...
			<th>Fecha</th>
                        ...
                        <tbody>
                            ...
                            ArrayList<EgresoPersonal> lista3= 
                                    EgresoPersonalBD.mostrarEgresoPersonalFechaXFecha(idContrato2, fechaini, fechafin);
