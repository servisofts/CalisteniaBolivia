<%-- 
    Document   : modificarEgreso
    Created on : 5/12/2018, 11:10:28 AM
    Author     : pc
--%>
...
<!DOCTYPE html>
<%
    if((sesionOK1.getAttribute("cargo").equals("Ventas"))||(sesionOK1.getAttribute("cargo").equals("Administrador"))||(sesionOK1.getAttribute("cargo").equals("Gerencia"))){
%>
<%
    //Cliente cl = ClienteBD.mostrarCliente2(Integer.parseInt(request.getParameter("id")));
    ArrayList list = PersonalBD.mostrarDetalleEgresoCaja2(Integer.parseInt(request.getParameter("id")));
    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Modificar datos del Egreso</h2>
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="ServletControlador" method="post" >                        
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Id Egreso</label>
                        <div class="control-label col-md-2 col-sm-2 col-xs-12">
                            <input type="text" class="form-control" value="<%=list.get(0)%>" readonly="" name="idEgreso">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="control-label col-md-3 col-sm-3 col-xs-12">
                            <input type="text" class="form-control" name="monto" value="<%=list.get(1)%>" maxlength="20" required="">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="control-label col-md-3 col-sm-3 col-xs-12">
                            <input type="text" class="form-control" name="detalle" value="<%=list.get(2)%>" maxlength="20" required=""> 
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                            <input type="submit" class="btn btn-primary" value="Modificar" name="btnModificar">
                            <input type="hidden" name="accion" value="ModificarEgresoCaja"/>
                        </div>
                      </div>
