          ...
          <!-- /top tiles -->
            ...
            <div class="row">
                    ...
                    <form id="formulario" data-parsley-validate class="form-horizontal form-label-left" action=
                           "modificarIngresosC.jsp" method="post" >
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="control-group">
                            <div class="controls">
                            <label class="control-label col-md-11 col-sm-39 col-xs-12" for="first-name">Mostrar Ingresos de Caja Cerradas por Fecha y Personal para ser Modificadas</label>
                            </div>
                          </div>
