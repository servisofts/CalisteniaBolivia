      ...
      <div class="main_container">
        ...
        <!-- /top tiles -->
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                    <h2>Reportes de Egresos<code>PERSONAL y CUENTASxPAGAR</code></h2>
            ...
            <div class="row">
                 ...
                 <div class="agile-title form-group">                             
                    <form id="formulario" data-parsley-validate class="form-horizontal form-label-left" action=
                           "estadoEgresoPersonalmes.jsp" method="post" >
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="control-group">
                            <div class="controls">
                            <label class="control-label col-md-9 col-sm-39 col-xs-12" for="first-name">Mostrar Total de Egresos por Fecha y Personal</label>
                            </div>
                          </div>
                 ...
                 <div class="agile-title form-group">                             
                    <form id="formulario" data-parsley-validate class="form-horizontal form-label-left" action=
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="control-group">
                            <div class="controls">
                            <label class="control-label col-md-9 col-sm-39 col-xs-12" for="first-name">Mostrar Total de Cuentas X Pagar por Fecha y Personal</label>
                            </div>
                          </div>
