...
<html lang="en">
  <head>
    ...
    <script src="js/eliminarOtroEgresoInact.js"></script>
    <!-- Custom Theme Style -->
    ...
    <div class="container body">
        ...
        <div class="right_col" role="main">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Eliminar Otros Egresos <code>Caja Cerrada</code></h2>
                        ...
                        <div class="table-responsive">
                            ...
                            %>
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                    <%
                                        ArrayList<EgresoPersonal> lista= 
                                                EgresoPersonalBD.mostrarEliminarOtroEgresoInact(idContrato2,fecha);
                                                for(int i=0;i<lista.size();i++)
                                                {
                                                EgresoPersonal oe=lista.get(i);
                                    %>
                                        <tr>
                                            <td id="idOtroEgresoInact"><%=oe.getIdEgresoPersonal()%></td>
                                            <td><%=oe.getFecha()%></td>
                                            <td id="MontoInact"><%=oe.getMonto()%></td>
                                            <td id="Observacion"><%=oe.getObservacion()%></td>
                                            <td><div class="agile-title form-group">
                        <strong><a href="#<%=oe.getIdEgresoPersonal()%>" class="btn btn-danger" data-toggle="modal">
                                <h4 class="modal-title">
                                <span class=" glyphicon glyphicon-remove"></span> Eliminar
                        </h4></a></strong>
                         <div class="modal fade" id="<%=oe.getIdEgresoPersonal()%>">
                                   ...
                                   <div class="modal-content">
                                       <div class="modal-header">
                                           <button style="button" class="close" data-dismiss="modal">
                                            ...
                                            <div class="agile-title">
                                                <h3 class="modal-title"><strong>Eliminar otro egreso</strong></h3> 
					</div>
                                               <div class="container">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-md-2 col-sm-6 col-xs-12">
                                              <input type="text" name="txtId" class="form-control col-md-2 " value="<%=oe.getIdEgresoPersonal()%>"readonly="">
                                          </div>
                                        </div> 
                                        <div class="form-group">
                                          ...
                                          <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                            <button type="submit" class="btn btn-danger" name="btnEliminar">
                                              ...
                                              <span class="glyphicon glyphicon-remove"></span>
                                                                 ...
                                                                 <input type="hidden" name="accion" value="EliminarOtroEgreso"/>
                                          </div>
                                        </div>
                                           ...
                                           <td id="idCajaInact" hidden=""><%=oe.getIdCaja()%></td>
                                           <td id="Tipo" hidden="">Otro Egreso</td>
                                        </tr>
                                        <%
                                            }
                                        %>
