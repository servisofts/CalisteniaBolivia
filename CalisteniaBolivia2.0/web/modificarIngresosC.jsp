        ...
        <div class="right_col" role="main">
          ...
          <!-- /top tiles -->
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                    <h2>Ingresos de Caja Cerrada</h2>
        ...
        <div class="w3ls-row" id="div1">
			...
			<th>Monto en Bs</th>
                        ...
                        <tbody>
                            ...
                            ArrayList lista3= 
                                   IngresoBD.mostrarIngresoC(fechaini);
                            for(int i=0;i<lista3.size();i++)
                            {
                                int id=(Integer) lista3.get(i);
                                i++;
                                String nombre=(String) lista3.get(i);
                                i++;
                                double monto = (double) lista3.get(i);   
                                i++;
                                String glosa = (String) lista3.get(i);
                                i++;
                                String paquete = (String) lista3.get(i);
                                i++;
                                int tipoIngreso = (Integer) lista3.get(i);
                                i++;
                                String caja1 = (String) lista3.get(i);
                                i++;
                                int idPaquete = (Integer) lista3.get(i);
                                i++;
                                int idCaja = (Integer) lista3.get(i);
                                        %>
                            <tr>
                                <td><%=id%></td>
                                <td><%=nombre%></td>
                        ...
                        <strong><a href="#<%=id%>" class="btn btn-info" data-toggle="modal">
                                   ...
                                   <div class="modal-content">
                                       <div class="modal-header">
                                           <button style="button" class="close" data-dismiss="modal">
                                            ...
                                            <div class="agile-title">
                                                <h3 class="modal-title"><strong>Modificar Ingreso</strong></h3> 
					</div>
                                               <div class="container">
                                        ...
                                        <div class="hidden">
                                          ...
                                          <div class="col-md-2 col-sm-6 col-xs-12">
                                              <input type="text" name="txtId" class="form-control col-md-2 " value="<%=id%>"readonly="">
                                          </div>
                                        </div> 
                                        <div class="hidden">
                                          ...
                                          <div class="col-md-2 col-sm-6 col-xs-12">
                                              <input type="text" name="txtIdCaja" class="form-control col-md-2 " value="<%=idCaja%>"readonly="">
                                          </div>
                                        </div>
                                          
                                          <div class="hidden">
                                          <label class="control-label col-md-3" for="last-name">Id Paquete<span class="required">*</span>
                                          </label>
                                          <div class="col-md-2 col-sm-6 col-xs-12">
                                              <input type="text" name="txtIdPaquete" class="form-control col-md-2 " value="<%=idPaquete%>"readonly="">
                                          </div>
                                        </div>
                                          
                                          <div class="hidden">
                                          <label class="control-label col-md-3" for="last-name">Tipo de Ingreso<span class="required">*</span>
                                          </label>
                                          <div class="col-md-2 col-sm-6 col-xs-12">
                                              <input type="text" name="txtTipoIngreso" class="form-control col-md-2 " value="<%=tipoIngreso%>"readonly="">
                                          </div>
                                        </div>                                                                         
                                          
                                          <div class="form-group">
                                          <label class="control-label col-md-3" for="last-name">Fecha<span class="required"></span>
                                          </label>
                                          <div class="col-md-6 col-sm-6 col-xs-12">
                                              <input type="text" name="txtFecha" class="form-control col-md-2 " value="<%=fechaini%>"readonly="">
                                          </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-md-6 col-sm-6 col-xs-12">
                                              <input type="text" id="last-name" name="txbMontoEP" required="required" class="form-control col-md-7 col-xs-12" value="<%=monto%>" placeholder="Nombre del Cargo">
                                          </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-md-6 col-sm-6 col-xs-12">
                                              <input type="text" id="last-name" name="txbObservacionEP" required="required" class="form-control col-md-7 col-xs-12" value="<%=glosa%>" placeholder="Nombre del Cargo">
                                          </div>
                                        </div>
                                          ...
                                          <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                            <button type="submit" class="btn btn-info" name="btnModificar">
                                              ...
                                              <span class="glyphicon glyphicon-refresh"></span>
                                                                 ...
                                                                 <input type="hidden" name="accion" value="ModificarIngresoC"/>
                                          </div>
                                        </div>
