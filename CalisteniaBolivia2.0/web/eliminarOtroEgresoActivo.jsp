...
<html lang="en">
  <head>
    ...
    <script src="js/eliminarOtroEgresoAc.js"></script>
    <!-- Custom Theme Style -->
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <%
                                        ArrayList<EgresoPersonal> lista= 
                                                EgresoPersonalBD.mostrarOtroEgresoDiario(idContrato2);
                                                for(int i=0;i<lista.size();i++)
                                                {
                                                EgresoPersonal oe=lista.get(i);
                                    %>
                                        <tr>
                                            <td id="idOtroEgresoAct"><%=oe.getIdEgresoPersonal()%></td>
                                            <td><%=oe.getFecha()%></td>
                                            <td id="Monto"><%=oe.getMonto()%></td>
