...
<html lang="en">
  <head>
    ...
    <script src="js/eliminarEgresoChequeProInact1.js" type="text/javascript"></script>
    <script src="js/eliminarEgresoTransProInact.js" type="text/javascript"></script>
    <script>
         ...
         <%@include file="options.jsp" %>
          <!-- /top tiles -->
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                    <h2>Eliminar Otros Egresos (Proveedor) <code>CHEQUE o TRANSACCION BANCARIA</code></h2>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <%
                                        ArrayList<EgresoChequeTransPro> lista= 
                                                EgresoChequeTransProBD.mostrarEliminarOtroEgresoPrveedorChequeInact(idContrato2,fecha);
                                            for(int i=0;i<lista.size();i++)
                                            {
                                                EgresoChequeTransPro oe=lista.get(i);
                                    %>
                                        <tr>
                                            <td id="idEgresoChequeProInact1"><%=oe.getIdChequeTrans()%></td>
                                            <td><%=oe.getRazonSocial()%></td>
                                            <td><%=oe.getNombre()%> <%=oe.getApellido()%></td>
                                            <td><%=oe.getFecha()%></td>
                                            <td id="MontoChequeProInact1"><%=oe.getMonto()%></td>
                                          ...
                                          <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                            <button type="submit" class="btn btn-danger" name="btnEliminar">
                                              ...
                                              <span class="glyphicon glyphicon-remove"></span>
                                                                 ...
                                                                 <input type="hidden" name="accion" value="EliminarEgresoChequeTransPro"/>
                                          </div>
                                        </div>
			...
			<tr>
                        ...
                        <tbody>
                            ...
                            ArrayList<EgresoChequeTransPro> lista2= 
                                    EgresoChequeTransProBD.mostrarEliminarOtroEgresoPrveedorTransInact(idContrato2,fecha);
                            ...
                            for(int i=0;i<lista2.size();i++)
                            {
                                EgresoChequeTransPro oe=lista2.get(i);
                                        %>
                            <tr>
                                <td id="idEgresoTransProInact"><%=oe.getIdChequeTrans()%></td>
                                <td><%=oe.getRazonSocial()%></td>
                                <td><%=oe.getNombre()%> <%=oe.getApellido()%></td>
                                <td><%=oe.getFecha()%></td>
                                <td id="MontoTransProInact"><%=oe.getMonto()%></td>
                                <td><%=oe.getObservacion()%></td>
                                <td><%=oe.getTipoPago()%></td>
                                <td><%=oe.getNumero()%></td>
                                <td><%=oe.getEntidad()%></td>
