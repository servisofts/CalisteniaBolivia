        ...
        <div class="right_col" role="main">
          ...
          <!-- /top tiles -->
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Eliminar Ingreso Tarjeta</h2>
                    ...
                    %> 
                      ...
                      <tbody>
                           ...
                           <%
                            ...
                            ArrayList<Ingreso> lista= IngresoBD.mostrarEliminarIngresoTarjeta();
                                          ...
                                          <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                            <button type="submit" class="btn btn-danger" name="btnModificar">
                                              ...
                                              <span class="glyphicon glyphicon-remove"></span>
                                                                 ...
                                                                 <input type="hidden" name="accion" value="EliminarIngresoTarjeta"/>
                                          </div>
                                        </div>
