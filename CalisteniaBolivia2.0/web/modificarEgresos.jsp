    ...
    <div class="container body">
        ...
        <div class="right_col" role="main">
          ...
          <!-- /top tiles -->
            ...
            <div class="row">
                    ...
                    <form id="formulario" data-parsley-validate class="form-horizontal form-label-left" action=
                           "modificarEgresosC.jsp" method="post" >
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="control-group">
                            <div class="controls">
                            <label class="control-label col-md-11 col-sm-39 col-xs-12" for="first-name">Mostrar Egresos de Caja Cerradas por Fecha y Personal para ser Modificadas</label>
                            </div>
                          </div>
          ...
          <br />
                     ...
                     <div class="agile-title form-group">                             
                    <form id="formulario" data-parsley-validate class="form-horizontal form-label-left" action=
                           "modificarEgresosA.jsp" method="post" >
                        <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="control-group">
                            <div class="controls">
                            <label class="control-label col-md-11 col-sm-39 col-xs-12" for="first-name">Mostrar Egresos de Caja Abierta por Fecha y Personal para ser Modificadas</label>
                            </div>
                          </div>
