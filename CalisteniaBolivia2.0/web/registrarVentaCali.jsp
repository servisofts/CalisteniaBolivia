                            ...
                            <div class="row">
                                <div class="col-sm-12 table-responsive">
                                    <div class="card-box " id="cart-container">
                                        ...
                                        <input type="hidden" name="accion" value="RegistrarVentaCali2"/>
                                                ...
                                                %>
                                                    ...
                                                    <tr >
                                                        ...
                                                        <td>
                                                            ...
                                                            <button  type="submit" id="btnVenta" name="btnVenta" class=" btn btn-primary btn-group-lg">
