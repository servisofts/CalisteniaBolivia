                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                           ...
                           <%
                            ...
                            ArrayList<VitacoraIngreso> lista= VitacoraIngresoBD.mostrarVitacoraIngreso();

                            for(int i=0;i<lista.size();i++)
                            {
                                VitacoraIngreso cl=lista.get(i);
                                        %>
                            <tr>
                                <td><%=cl.getIdVitacora()%></td>
                                <td><%=cl.getNombreCli()%></td>
                                <td><%=cl.getAppCli()%></td>
                                <td><%=cl.getPaquete()%> </td>
                                <td><%=cl.getMonto()%></td>
                                <td><%=cl.getFechaEliminado()%></td>
                                <td><%=cl.getObservacion()%></td>
                                <td><%=cl.getNombrePer()%></td>
