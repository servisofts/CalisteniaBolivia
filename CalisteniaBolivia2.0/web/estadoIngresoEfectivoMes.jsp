    ...
    <div class="container body">
        ...
        <div class="right_col" role="main">
          ...
          <!-- /top tiles -->
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                    <h2>Estado Ingreso Efectivo Calistenia</h2>
        ...
        <div class="w3ls-row" id="div1">
            ...
            <div class="table-responsive">
                ...
                <div class="agile-title"  >
                    <H2>Ingreso Efectivo Calistenia entre la Fecha <label class="red"><% out.println(fechaini);%></label> y Fecha <label class="red"><% out.println(fechafin);%></label> </H2> 
                </div>
            <label>Total:  </label><br>
            <%
                    if((sesionOK.getAttribute("cargo").equals("Gerencia"))||(sesionOK.getAttribute("cargo").equals("Administrador"))){
                    Ingreso icp= IngresoBD.mostrarTotalIngresoEfectivoCaliFechaXFecha(idContrato2, fechaini, fechafin);
                    %>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            ArrayList<Ingreso> lista= 
                                    IngresoBD.mostrarIngresoEfectivoCaliFechaXFecha(idContrato2, fechaini, fechafin);
