...
<html lang="en">
  <head>
    ...
    <script src="js/eliminarEgresoChequeTransPerAct.js" type="text/javascript"></script>
    <script src="js/eliminarEgresoTransPerAct.js" type="text/javascript"></script>
    <script>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        ArrayList<EgresoChequeTrans> lista= 
                                                EgresoChequeTransBD.mostrarEliminarOtroEgresoPersonalChequeAct(idContrato2);
                                        ...
                                        for(int i=0;i<lista.size();i++)
                                        {
                                            EgresoChequeTrans oe=lista.get(i);
                                                    %>
                                        <tr>
                                            <td id="idEgresoChequeTransPerAct"><%=oe.getIdChequeTrans()%></td>
                                            ...
                                            <td><%=oe.getNumero()%></td>
                                            <td>
                                            <a id="btn-eliminar"><i class="fa fa-times btn btn-danger"></i></a>
                                           </td>
                                        </tr>
                                        <%
			...
			<tr>
                        ...
                        <tbody>
                            ...
                            ArrayList<EgresoChequeTrans> lista2= 
                                    EgresoChequeTransBD.mostrarEliminarOtroEgresoPersonalTransAct(idContrato2);
                            ...
                            <tr>
                                ...
                                <td><%=oe.getMonto()%></td>
                                <td><%=oe.getObservacion()%></td>
                                <th><%=oe.getTipoPago()%></th>
                                <th><%=oe.getNumero()%></th>
                                <th><%=oe.getEntidad()%></th>
                                <td> 
                                <a id="btn-eliminar2"><i class="fa fa-times btn btn-danger"></i></a>
                               </td>
                            </tr>
                            <%
                                }
