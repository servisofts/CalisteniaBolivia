    ...
    <div class="container body">
        ...
        <div class="right_col" role="main">
          ...
          <!-- /top tiles -->
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Paquetes Activos Calistenia</h2>
                    ...
                    <div class="agile-title form-group">
                        <strong><a href="#NuevoPaquete" class="btn btn-primary" data-toggle="modal">
                                ...
                                <span class="fa fa-plus-square"></span> Nuevo Paquete Calistenia
                        </h4></a></strong>
                                       ...
                                       <div class="modal-header">
                                           <button style="button" class="close" data-dismiss="modal">
                                            ...
                                            <div class="agile-title">
                                                <h3 class="modal-title"><strong>Nuevo Paquete Calistenia</strong></h3> 
					</div>
                                               <div class="container">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-md-6 col-sm-6 col-xs-12">
                                              <input type="text" id="last-name" name="txbDuracionPq" required="required" class="form-control col-md-7 col-xs-12" value="" placeholder="Duracion Paquete">
                                          </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                          <div class="col-md-6 col-sm-6 col-xs-12">                   
                                              ...
                                              <input type="text" id="last-name" name="txbCategoriaPaquetePq" required="required" class="form-control col-md-7 col-xs-12" value="1" style="visibility: hidden">
                                          </div>
                                        </div>
                                          ...
                                          <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                            <button type="submit" class="btn btn-info" name="btnGuardar">
                                              ...
                                              <span class="fa fa-check"></span>
                                                                 ...
                                                                 <input type="hidden" name="accion" value="GuardarPaquete"/>
                                          </div>
                                        </div>
                ...
                %>
                        ...
                        <!-- price element -->
                        <%
                ArrayList<Paquete> lista3= PaqueteBD.mostrarPaqueteActivas();
                int salto1=0;
                                          ...
                                          <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                            <button type="submit" class="btn btn-info" name="btnModificar">
                                              ...
                                              <span class=" glyphicon glyphicon-refresh"></span>
                                                                 ...
                                                                 <input type="hidden" name="accion" value="ModificarPaquete"/>
                                          </div>
                                        </div>
                                          ...
                                          <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                            <button type="submit" class="btn btn-danger" name="btnDesactivar">
                                              ...
                                              <span class=" fa fa-close"></span>
                                                                 ...
                                                                 <input type="hidden" name="accion" value="DesactivarPaquete"/>
                                          </div>
                                        </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Paquetes Inactivos Calistenia</h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
                      <li class="dropdown">
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            <!-- price element -->
                        <%
                ArrayList<Paquete> lista4= PaqueteBD.mostrarPaqueteInactivas();
                int salto2=0;
                                          ...
                                          <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                            <button type="submit" class="btn btn-success" name="btnActivar">
                                              ...
                                              <span class=" fa fa-check"></span>
                                                                 ...
                                                                 <input type="hidden" name="accion" value="ActivarPaquete"/>
                                          </div>
                                        </div>
