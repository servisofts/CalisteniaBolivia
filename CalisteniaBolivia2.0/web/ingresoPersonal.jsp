            ...
            <div class="x_content">
                <div class="row">
                  ...
                  <div class="x_content">
                    ...
                    %>
                          <!--  <input type="text" class="form-control" value="<%//=l2.getIdCaja()%>" name="txbCajaCa" readonly=""> -->
                        <%
                        //}
                        %>
                        <!--</div>
                        ...
                        <div class="col-md-2  col-sm-2 col-xs-12">
                            <input type="text" name="txbCajaCa" id="txtIdCajaCp" value="" readonly=""> 
                        </div>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <textarea id="message" class="form-control" name="txbOvbervacionCa" data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="100" data-parsley-validation-threshold="10"></textarea>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                            ...
                            <input type="hidden" name="accion" value="GuardarOtroIngreso"/>
                        </div>
                      </div>
