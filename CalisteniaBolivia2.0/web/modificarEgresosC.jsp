			...
			<th>Fecha</th>
                        ...
                        <tbody>
                            ...
                            ArrayList<EgresoPersonal> lista3= 
                                    EgresoPersonalBD.mostrarEgresoDiarioPersonalC(fechaini,idContrato2);
                                   ...
                                   <div class="modal-content">
                                       <div class="modal-header">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-md-2 col-sm-6 col-xs-12">
                                              <input type="text" name="txbidCierreCajaEP" class="form-control col-md-2 " value="<%=eg.getCierreCaja()%>"readonly="">
                                          </div>
                                        </div>        
                                          ...
                                          <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                            <button type="submit" class="btn btn-info" name="btnModificar">
                                              ...
                                              <span class="glyphicon glyphicon-refresh"></span>
                                                                 ...
                                                                 <input type="hidden" name="accion" value="ModificarEgresoPersonalC"/>
                                          </div>
                                        </div>
